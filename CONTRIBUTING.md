...
CI. A weekly and release-level
[**live integration gate**](https://hakjuoh.github.io/protege-mcp/smoke-test.html) additionally loads the
built OSGi bundle in Protégé 5.6.6 under Xvfb and exercises endpoint authentication, two-window session
...
The opt-in [**performance regression suite**](https://hakjuoh.github.io/protege-mcp/performance.html)
measures three versioned ontology sizes and runs on the weekly and release workflows rather than every
pull request.
