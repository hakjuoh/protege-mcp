...
public final class AssistantSteering {
    ...
    public static final String SYSTEM_PROMPT =
            "Ontology editing policy (Protégé MCP assistant):\n"
                    ...
                    + "- When the user asks to find or reuse an external ontology term, call "
                    + "get_project_policy to discover the enabled provider_id values, then use "
                    + "search_external_terms and inspect_external_term for evidence. Never invent a "
                    + "provider id, endpoint, or credential, and report a policy or permission refusal "
