...
| [Tools](https://hakjuoh.github.io/protege-mcp/tools/) | All 63 tools by category, each with **arguments and returns**, plus the axiom-type catalog and guided prompts. |
...
- **63 structured tools + 6 guided prompts** over the live, active ontology — explore, edit, curate,
  govern, extract modules, run SWRL rules and SPARQL, and reason.
