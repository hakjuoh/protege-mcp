...
- **85 structured tools + 11 guided prompts** over the live, active ontology — explore, edit, curate,
...
- **Least-privilege OAuth** — all 85 tools declare and enforce ontology, release, filesystem, network,
