...
so the client can *explore it and make edits for you* through **63 structured tools** and **6 guided
prompts**.
...
| [Tools](tools/) | All 63 tools by category, each with **arguments and returns**, plus the axiom-type catalog and guided prompts. |
