...
so the client can *explore it and make edits for you* through **79 structured tools** and **11 guided
prompts**.
...
| [Tools](tools/) | All 79 tools by category, including a summary of the 12 tools added in v0.6.0. |
