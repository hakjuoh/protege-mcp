...
jobs:
  ontology-ci:
    permissions:
      contents: read
    uses: hakjuoh/protege-mcp/.github/workflows/ontology-ci.yml@v0.8.0
    with:
...
jobs:
  annotate:
    permissions:
      ...
      checks: write
      pull-requests: write
    uses: hakjuoh/protege-mcp/.github/workflows/ontology-annotate.yml@v0.8.0
    with:
