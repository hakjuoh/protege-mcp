...
This is *Architecture Approach B* in the project's [design](https://github.com/hakjuoh/protege-mcp/blob/main/DESIGN.md):
a thin UI over a CLI you trust, reusing the MCP tool layer rather than duplicating it.
